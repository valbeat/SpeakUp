...
// ver 1.3.1
//
var SpeechRec=window.SpeechRec={};SpeechRec.DEFAULT_CONFIG={ApiKey:"",OpusWorkerUrl:"libopus.worker.js",NrFlag:!0,SbmMode:2,Nbest:10,mic_recorder_port:2001,buffer_size_as_seconds:60,UserDefine:navigator.webkitGetUserMedia?"Chrome":"IE",UserAgent:"",ContinuousMode:!1};SpeechRec.is_little_endian=!!(new Uint8Array((new Uint16Array([1])).buffer))[0];
navigator.getUserMedia?(SpeechRec.DEFAULT_CONFIG.UserDefine="HTML5",SpeechRec.user_media="getUserMedia"):navigator.webkitGetUserMedia?(navigator.getUserMedia=navigator.webkitGetUserMedia,SpeechRec.DEFAULT_CONFIG.UserDefine="Chrome",SpeechRec.user_media="webkitGetUserMedia"):navigator.mozGetUserMedia?(navigator.getUserMedia=navigator.mozGetUserMedia,SpeechRec.DEFAULT_CONFIG.UserDefine="Firefox",SpeechRec.user_media="mozGetUserMedia"):(SpeechRec.DEFAULT_CONFIG.UserDefine="IE",SpeechRec.user_media="");
...
SpeechRec._cb.all=function(a,c){if(!SpeechRec._fn.is_string(a)){var b={name:"fatal_error"};b.message="_cb.all NG (! _fn.is_string(cb_name)): "+JSON.stringify(a);SpeechRec._cb.all("error",b)}else if(a in SpeechRec._cb._fn)if(SpeechRec._cb._fn[a]instanceof Array)for(b=0;b<SpeechRec._cb._fn[a].length;b++)SpeechRec._cb._fn[a][b](c);else b={name:"fatal_error"},b.message="_cb.all NG (! (_cb._fn["+a+"] instanceof Array)): "+JSON.stringify(SpeechRec._cb._fn[a]),SpeechRec._cb.all("error",b)};
SpeechRec._cb.add=function(a,c){if(SpeechRec._fn.is_string(a))c instanceof Function?(a in SpeechRec._cb._fn||(SpeechRec._cb._fn[a]=[]),SpeechRec._cb._fn[a]instanceof Array?SpeechRec._cb._fn[a].push(c):(b={name:"fatal_error"},b.message="_cb.add NG (! (_cb._fn[cb_name] instanceof Array)): "+JSON.stringify(SpeechRec._cb._fn[a]),SpeechRec._cb.all("error",b))):(b={name:"fatal_error"},b.message="_cb.add NG (! (cb_fn instanceof Function)): "+JSON.stringify(c),SpeechRec._cb.all("error",b));else{var b={name:"fatal_error"};
b.message="_cb.add NG (! _fn.is_string(cb_name)): "+JSON.stringify(a);SpeechRec._cb.all("error",b)}};SpeechRec._cb.del=function(a){if(SpeechRec._fn.is_string(a))SpeechRec._cb._fn[a]=[];else{var c={name:"fatal_error"};c.message="_cb.del NG (! _fn.is_string(cb_name)): "+JSON.stringify(a);SpeechRec._cb.all("error",c)}};SpeechRec.on_error=function(a){SpeechRec._cb.add("error",a)};SpeechRec.on_config=function(a){SpeechRec._cb.add("config",a)};SpeechRec.on_start=function(a){SpeechRec._cb.add("start",a)};
SpeechRec.on_stop=function(a){SpeechRec._cb.add("stop",a)};SpeechRec.on_ask=function(a){SpeechRec._cb.add("ask",a)};SpeechRec.on_allow=function(a){SpeechRec._cb.add("allow",a)};SpeechRec.on_deny=function(a){SpeechRec._cb.add("deny",a)};SpeechRec.on_voiceless=function(a){SpeechRec._cb.add("voiceless",a)};SpeechRec.on_voice_begin=function(a){SpeechRec._cb.add("voice_begin",a)};SpeechRec.on_voice_too_long=function(a){SpeechRec._cb.add("voice_too_long",a)};
SpeechRec.on_voice_end=function(a){SpeechRec._cb.add("voice_end",a)};SpeechRec.on_no_result=function(a){SpeechRec._cb.add("no_result",a)};SpeechRec.on_result=function(a){SpeechRec._cb.add("result",a)};SpeechRec.on_mic_enabled=function(a){SpeechRec._cb.add("mic_enabled",a)};SpeechRec.on_mic_disabled=function(a){SpeechRec._cb.add("mic_disabled",a)};SpeechRec.on_proc=function(a){SpeechRec._cb.add("proc",a)};SpeechRec.on_audio_pressure_level=function(a){SpeechRec._cb.add("audio_pressure_level",a)};
SpeechRec.on_state_changed=function(a){SpeechRec._cb.add("state_changed",a)};SpeechRec.on_send=function(a){SpeechRec._cb.add("send",a)};SpeechRec.on_recv=function(a){SpeechRec._cb.add("recv",a)};SpeechRec.CLIENT_STATE={ASKING:void 0,ALLOW:void 0,DENY:void 0,START:void 0,STOP:void 0,"(CHANGING)":void 0,"(IN ERROR)":void 0};SpeechRec.WebAudio=function(){this._jsnode=this._source=this._context=this._stream=this._on_pcm=void 0;this._skip_data=!0;this._state="ASK";return this};
SpeechRec.WebAudio.prototype.initialize=function(a){a=a||{};if(!(a.on_pcm instanceof Function))throw{name:"fatal_error",message:"\u30af\u30e9\u30a4\u30a2\u30f3\u30c8\u90e8(\u30de\u30a4\u30af)\u306e\u521d\u671f\u5316\u306b\u5931\u6557\u3057\u307e\u3057\u305f (option.on_pcm\u306b\u306f\u95a2\u6570\u3092\u6307\u5b9a\u3057\u3066\u4e0b\u3055\u3044)"};void 0!==this._on_pcm&&delete this._on_pcm;this._on_pcm=a.on_pcm;void 0!==this._jsnode&&(void 0!==this._jsnode.onaudioprocess&&delete this._jsnode.onaudioprocess,
...
SpeechRec.WebSocket.prototype.initialize=function(a){a=a||{};if(!(a.on_error instanceof Function)){var c={name:"fatal_error"};c.message=this._name+"\u306e\u521d\u671f\u5316\u306b\u5931\u6557\u3057\u307e\u3057\u305f (option.on_error\u306b\u306f\u95a2\u6570\u3092\u6307\u5b9a\u3057\u3066\u304f\u3060\u3055\u3044)";throw c;}void 0!==this._on_error&&delete this._on_error;this._on_error=a.on_error;SpeechRec._fn.is_string(a.url)||(c={name:"fatal_error"},c.message=this._name+"\u306e\u521d\u671f\u5316\u306b\u5931\u6557\u3057\u307e\u3057\u305f (option.url\u306b\u306f\u6587\u5b57\u5217\u3092\u6307\u5b9a\u3057\u3066\u4e0b\u3055\u3044)",
this._on_error(c));this._url=a.url;if(void 0===a.callbacks)a.callbacks=[];else{"object"!==typeof a.callbacks&&(c={name:"fatal_error"},c.message=this._name+"\u306e\u521d\u671f\u5316\u306b\u5931\u6557\u3057\u307e\u3057\u305f (option.callbacks\u306b\u306f\u30cf\u30c3\u30b7\u30e5\u3092\u6307\u5b9a\u3057\u3066\u4e0b\u3055\u3044)",this._on_error(c));for(var b in a.callbacks)SpeechRec._fn.is_string(b)||(c={name:"fatal_error"},c.message=this._name+"\u306e\u521d\u671f\u5316\u306b\u5931\u6557\u3057\u307e\u3057\u305f (option.callbacks\u30cf\u30c3\u30b7\u30e5\u306e\u30ad\u30fc\u306b\u306f\u6587\u5b57\u5217\u3092\u6307\u5b9a\u3057\u3066\u4e0b\u3055\u3044)",
this._on_error(c)),a.callbacks[b]instanceof Function||(c={name:"fatal_error"},c.message=this._name+"\u306e\u521d\u671f\u5316\u306b\u5931\u6557\u3057\u307e\u3057\u305f (option.callbacks\u30cf\u30c3\u30b7\u30e5\u306e\u5024\u306b\u306f\u95a2\u6570\u3092\u6307\u5b9a\u3057\u3066\u4e0b\u3055\u3044)",this._on_error(c))}void 0!==this._callbacks&&delete this._callbacks;this._callbacks=a.callbacks;void 0!==this._ws&&delete this._ws;this._ws=void 0};
...
SpeechRec.WebSocket.prototype.open=function(a){if(this._ws instanceof WebSocket)a instanceof Function&&a();else{try{this._ws=new WebSocket(this._url)}catch(c){a={name:"WebSocket_error"};a.message=this._name+"\u3068\u306e\u63a5\u7d9a\u306b\u5931\u6557\u3057\u307e\u3057\u305f("+JSON.stringify(c)+")";this._on_error(a);return}this._ws.binaryType="arraybuffer";this._ws._name=this._name;this._ws._last_proc="new WebSocket("+this._url+");";this._ws._on_error=this._on_error;this._ws._callbacks=this._callbacks;
this._ws._callbacks.error=this._on_error;this._ws._one_time_callback={};this._ws.onmessage=this.on_message;this._ws._on_error=this._on_error;this._ws.onerror=function(a){var c={};void 0!==this._last_proc?(c.name="WebSocket_error",c.message=this._name+"\u3068\u306e\u63a5\u7d9a\u306b\u5931\u6557\u3057\u307e\u3057\u305f",delete this._last_proc):SpeechRec._fn.is_string(a.name)&&SpeechRec._fn.is_string(a.message)?(c.name="WebSocket_error",c.message=this._name+"\u3067\u30a8\u30e9\u30fc\u304c\u767a\u751f\u3057\u307e\u3057\u305f("+
JSON.stringify({name:a.name,message:a.message})+")"):(c.name="WebSocket_error",c.message=this._name+"\u3067\u30a8\u30e9\u30fc\u304c\u767a\u751f\u3057\u307e\u3057\u305f("+JSON.stringify(a)+")");this._on_error(c)};this._ws._on_open=a;this._ws.onopen=function(){delete this._last_proc;this.onclose=function(){this._closed=!0;var a={name:"WebSocket_error"};a.message=this._name+"\u304b\u3089\u5207\u65ad\u3055\u308c\u307e\u3057\u305f";this._on_error(a)};this._on_open instanceof Function&&this._on_open();
SpeechRec._state_changed()}}};SpeechRec.WebSocket.prototype.close=function(a){this._ws instanceof WebSocket?this._ws._closed?(SpeechRec._state_changed(),a instanceof Function&&a(),delete this._ws,this._ws=void 0):(this._ws.onclose=function(){},delete this._ws.onclose,this._ws.close(),delete this._ws,this._ws=void 0,SpeechRec._state_changed(),a instanceof Function&&a()):(SpeechRec._state_changed(),a instanceof Function&&a(),delete this._ws,this._ws=void 0)};
...
SpeechRec.WebSocket.prototype.on_message=function(a){if(a)if(a.data)if(a=new Uint8Array(a.data),130===a[0]){var c=msgpack.unpack(a);SpeechRec._cb.all("recv",{name:this._name,unpacked:c});if(c instanceof Object)if("key"in c)if("value"in c){a=c.key;var b=c.value;SpeechRec._fn.is_string(a)?(("configured"===a||"result"===a||"error"===a)&&SpeechRec._fn.is_string(b)&&(b=JSON.parse(b)),"error"===a&&(d={},SpeechRec._fn.is_string(b.name)&&SpeechRec._fn.is_string(b.message)?(d.name="runtime_error",d.message=
this._name+'\u304b\u3089\u30a8\u30e9\u30fc\u304c\u901a\u77e5\u3055\u308c\u307e\u3057\u305f( name:"'+b.name+'", message:"'+b.message+'")'):(d.name="runtime_error",d.message=this._name+"\u304b\u3089\u30a8\u30e9\u30fc\u304c\u901a\u77e5\u3055\u308c\u307e\u3057\u305f("+JSON.stringify(b)+")"),b=d),a in this._callbacks?(c=this._callbacks[a],c(b)):a in this._one_time_callback?(c=this._one_time_callback[a],delete this._one_time_callback[a],c(b),void 0!==SpeechRec._timer[a]&&(clearTimeout(SpeechRec._timer[a]),
delete SpeechRec._timer[a])):console.warn(this._name+"\u304c\u4e0d\u9069\u5207\u306a\u30e1\u30c3\u30bb\u30fc\u30b8\u3092\u53d7\u4fe1\u3057\u305f\u305f\u3081\u7121\u8996\u3057\u307e\u3057\u305f: "+JSON.stringify(c))):(d={name:"invalid_message"},d.message=this._name+"\u304b\u3089\u4e0d\u6b63\u306a\u30e1\u30c3\u30bb\u30fc\u30b8\u3092\u53d7\u4fe1\u3057\u307e\u3057\u305f (type5): "+JSON.stringify(c),this._on_error(d))}else d={name:"invalid_message"},d.message=this._name+"\u304b\u3089\u4e0d\u6b63\u306a\u30e1\u30c3\u30bb\u30fc\u30b8\u3092\u53d7\u4fe1\u3057\u307e\u3057\u305f (type4): "+
JSON.stringify(c),this._on_error(d);else d={name:"invalid_message"},d.message=this._name+"\u304b\u3089\u4e0d\u6b63\u306a\u30e1\u30c3\u30bb\u30fc\u30b8\u3092\u53d7\u4fe1\u3057\u307e\u3057\u305f (type3): "+JSON.stringify(c),this._on_error(d);else d={name:"invalid_message"},d.message=this._name+"\u304b\u3089\u4e0d\u6b63\u306a\u30e1\u30c3\u30bb\u30fc\u30b8\u3092\u53d7\u4fe1\u3057\u307e\u3057\u305f (type2): "+JSON.stringify(c),this._on_error(d)}else 4<=a.length&&80==a[0]&&67==a[1]&&77==a[2]&&58==a[3]?
"pcm"in this._one_time_callback?(c=this._one_time_callback.pcm,delete this._one_time_callback.pcm,c(a)):console.warn(this._name+"\u304c\u4e0d\u9069\u5207\u306a\u30bf\u30a4\u30df\u30f3\u30b0\u3067PCM\u30c7\u30fc\u30bf\u3092\u53d7\u4fe1\u3057\u305f\u305f\u3081\u7121\u8996\u3057\u307e\u3057\u305f"):(d={name:"invalid_message"},d.message=this._name+"\u304b\u3089\u4e0d\u6b63\u306a\u30e1\u30c3\u30bb\u30fc\u30b8\u3092\u53d7\u4fe1\u3057\u307e\u3057\u305f (type6)",this._on_error(d));else d={name:"invalid_message"},
d.message=this._name+"\u304b\u3089\u4e0d\u6b63\u306a\u30e1\u30c3\u30bb\u30fc\u30b8\u3092\u53d7\u4fe1\u3057\u307e\u3057\u305f (type1)",this._on_error(d);else{var d={name:"invalid_message"};d.message=this._name+"\u304b\u3089\u4e0d\u6b63\u306a\u30e1\u30c3\u30bb\u30fc\u30b8\u3092\u53d7\u4fe1\u3057\u307e\u3057\u305f (type0)";this._on_error(d)}};
SpeechRec.WebSocket.prototype.set_one_time_callback=function(a,c,b,d){this._ws instanceof WebSocket?SpeechRec._fn.is_string(a)?c instanceof Function?(this._ws._one_time_callback[a]=c,b||SpeechRec._state_changed(),void 0===d&&(d=3E4),"(IN ERROR)"!==SpeechRec._state&&"pcm"!==a&&(SpeechRec._timer[a]=setTimeout(function(){for(var b in SpeechRec._timer)clearTimeout(SpeechRec._timer[b]),delete SpeechRec._timer[b];SpeechRec._timer={};b={name:"runtime_error"};b.message="timeout for "+a;SpeechRec._cb.all("error",
b)},d))):(c={name:"fatal_error"},c.message=this._name+"\u3078\u306e\u30b3\u30fc\u30eb\u30d0\u30c3\u30af\u306e\u8ffd\u52a0\u306b\u5931\u6557\u3057\u307e\u3057\u305f (callback\u306b\u306f\u95a2\u6570\u3092\u6307\u5b9a\u3057\u3066\u4e0b\u3055\u3044)",this._on_error(c)):(c={name:"fatal_error"},c.message=this._name+"\u3078\u306e\u30b3\u30fc\u30eb\u30d0\u30c3\u30af\u306e\u8ffd\u52a0\u306b\u5931\u6557\u3057\u307e\u3057\u305f (name\u306b\u306f\u6587\u5b57\u5217\u3092\u6307\u5b9a\u3057\u3066\u4e0b\u3055\u3044)",
this._on_error(c)):c instanceof Function&&(c(),b||SpeechRec._state_changed())};
SpeechRec.WebSocket.prototype.del_one_time_callback=function(a,c){if(this._ws instanceof WebSocket)if(SpeechRec._fn.is_string(a))a in this._ws._one_time_callback&&(delete this._ws._one_time_callback[a],void 0!==SpeechRec._timer[a]&&(clearTimeout(SpeechRec._timer[a]),delete SpeechRec._timer[a])),c||SpeechRec._state_changed();else{var b={name:"fatal_error"};b.message=this._name+"\u304b\u3089\u306e\u30b3\u30fc\u30eb\u30d0\u30c3\u30af\u306e\u524a\u9664\u306b\u5931\u6557\u3057\u307e\u3057\u305f (name\u306b\u306f\u6587\u5b57\u5217\u3092\u6307\u5b9a\u3057\u3066\u4e0b\u3055\u3044)";this._on_error(b)}};
...
SpeechRec._error_in_mic=function(a){if("(IN ERROR)"!==SpeechRec._state){SpeechRec._set_state("(IN ERROR)");if(!("name"in a)){var c={name:"fatal_error",message:"_error_in_mic(error) called, but (! ('name' in error))"};throw c;}if(!("message"in a))throw c={name:"fatal_error",message:"_error_in_mic(error) called, but (! ('message' in error))"},c;SpeechRec._rex.del_one_time_callback_all();SpeechRec.is_chrome()?SpeechRec._cwa.close(function(){SpeechRec._set_state("STOP");SpeechRec._cb.all("error",a);for(var b in SpeechRec._timer)clearTimeout(SpeechRec._timer[b]),
delete SpeechRec._timer[b];SpeechRec._timer={}}):(SpeechRec._mic.del_one_time_callback_all(),SpeechRec._mic.close(function(){SpeechRec._rex.recognition_stop(function(){SpeechRec._rex.recognizer_close(function(){SpeechRec._rex.close(function(){SpeechRec._set_state("STOP");SpeechRec._cb.all("error",a);for(var b in SpeechRec._timer)clearTimeout(SpeechRec._timer[b]),delete SpeechRec._timer[b];SpeechRec._timer={}})})})}))}};
...
SpeechRec._on_result=function(a){SpeechRec._rex.del_one_time_callback("no_result");SpeechRec._config.ContinuousMode?(SpeechRec._rex.set_one_time_callback("voiceless",SpeechRec._on_voiceless,!0),SpeechRec._rex.set_one_time_callback("voice_begin",SpeechRec._on_voice_begin),SpeechRec._cb.all("result",a)):(SpeechRec._set_state("(CHANGING)"),SpeechRec._rex.recognition_stop(function(){SpeechRec._rex.recognizer_close(function(){SpeechRec._rex.close(function(){SpeechRec._set_state("STOP");SpeechRec._cb.all("result",
a)})})}))};SpeechRec._set_state=function(a){if(!(a in SpeechRec.CLIENT_STATE)){var c={name:"fatal_error"};c.message="_set_state NG (! (new_state in SpeechRec.CLIENT_STATE)): "+a;throw c;}if("(IN ERROR)"===this._state&&"STOP"!==a)throw c={name:"fatal_error"},c.message='_set_state NG (his._state === "(IN ERROR)" && new_state !== "STOP"): '+a,c;this._state=a;SpeechRec._state_changed()};
SpeechRec._validate_config=function(a,c){if(!SpeechRec._fn.is_simple_hash(a)){var b={name:"invalid_config_value"};b.message="\u8a2d\u5b9a\u306b\u5931\u6557\u3057\u307e\u3057\u305f (config\u306b\u306f\u30b7\u30f3\u30d7\u30eb\u306a\u30cf\u30c3\u30b7\u30e5\u3092\u6307\u5b9a\u3057\u3066\u4e0b\u3055\u3044): "+JSON.stringify(a);throw b;}if(!0==c)for(var d in SpeechRec.DEFAULT_CONFIG)if(!(d in a))throw b={name:"fatal_error"},b.message="\u8a2d\u5b9a\u306b\u5931\u6557\u3057\u307e\u3057\u305f (\u5fc5\u8981\u306a\u9805\u76ee\u304c\u6307\u5b9a\u3055\u308c\u3066\u3044\u307e\u305b\u3093): config."+
d,b;for(var e in a)if(!(e in SpeechRec.DEFAULT_CONFIG))throw b={name:"invalid_config_value"},b.message="\u8a2d\u5b9a\u306b\u5931\u6557\u3057\u307e\u3057\u305f (\u4e0d\u6b63\u306a\u30e1\u30f3\u30d0\u304c\u6307\u5b9a\u3055\u308c\u307e\u3057\u305f): config."+e,b;if("ApiKey"in a){if(!SpeechRec._fn.is_string(a.ApiKey))throw b={name:"invalid_config_value"},b.message="\u8a2d\u5b9a\u306b\u5931\u6557\u3057\u307e\u3057\u305f (config.ApiKey\u306b\u306f\u6587\u5b57\u5217\u3092\u6307\u5b9a\u3057\u3066\u4e0b\u3055\u3044): "+
JSON.stringify(a.ApiKey),b;if(2048<a.ApiKey.length)throw b={name:"invalid_config_value",message:"\u8a2d\u5b9a\u306b\u5931\u6557\u3057\u307e\u3057\u305f (config.ApiKey\u306e\u9577\u3055\u304c\u4e0d\u9069\u5207\u3067\u3059 (>2048))"},b;}if("NrFlag"in a&&!SpeechRec._fn.is_boolean(a.NrFlag))throw b={name:"invalid_config_value"},b.message="\u8a2d\u5b9a\u306b\u5931\u6557\u3057\u307e\u3057\u305f (config.NrFlag\u306b\u306f\u771f\u507d\u5024\u3092\u6307\u5b9a\u3057\u3066\u4e0b\u3055\u3044): "+JSON.stringify(a.NrFlag),
b;if("SbmMode"in a)switch(a.SbmMode){case 0:case 1:case 2:case 3:break;default:throw b={name:"invalid_config_value"},b.message="\u8a2d\u5b9a\u306b\u5931\u6557\u3057\u307e\u3057\u305f (config.SbmMode\u306b\u306f0\uff5e3\u306e\u6574\u6570\u3092\u6307\u5b9a\u3057\u3066\u4e0b\u3055\u3044): "+JSON.stringify(a.SbmMode),b;}if("Nbest"in a){if(!SpeechRec._fn.is_number(a.Nbest))throw b={name:"invalid_config_value"},b.message="\u8a2d\u5b9a\u306b\u5931\u6557\u3057\u307e\u3057\u305f (config.Nbest\u306b\u306f1\uff5e10\u306e\u6574\u6570\u3092\u6307\u5b9a\u3057\u3066\u4e0b\u3055\u3044): "+
JSON.stringify(a.Nbest),b;b=Math.round(a.Nbest);if(a.Nbest!=b)throw b={name:"invalid_config_value"},b.message="\u8a2d\u5b9a\u306b\u5931\u6557\u3057\u307e\u3057\u305f (config.Nbest\u306b\u306f1\uff5e10\u306e\u6574\u6570\u3092\u6307\u5b9a\u3057\u3066\u4e0b\u3055\u3044): "+JSON.stringify(a.Nbest),b;if(1>a.Nbest&&10<a.Nbest)throw b={name:"invalid_config_value"},b.message="\u8a2d\u5b9a\u306b\u5931\u6557\u3057\u307e\u3057\u305f (config.Nbest\u306b\u306f1\uff5e10\u306e\u6574\u6570\u3092\u6307\u5b9a\u3057\u3066\u4e0b\u3055\u3044): "+
JSON.stringify(a.Nbest),b;}if("mic_recorder_port"in a){if(!SpeechRec._fn.is_number(a.mic_recorder_port))throw b={name:"invalid_config_value"},b.message="\u8a2d\u5b9a\u306b\u5931\u6557\u3057\u307e\u3057\u305f (config.mic_recorder_port\u306b\u306f1\uff5e60\u306e\u6570\u5024\u3092\u6307\u5b9a\u3057\u3066\u4e0b\u3055\u3044): "+JSON.stringify(a.mic_recorder_port),b;b=Math.round(a.mic_recorder_port);if(a.mic_recorder_port!=b)throw b={name:"invalid_config_value"},b.message="\u8a2d\u5b9a\u306b\u5931\u6557\u3057\u307e\u3057\u305f (config.mic_recorder_port\u306b\u306f0\uff5e65535\u306e\u6574\u6570\u3092\u6307\u5b9a\u3057\u3066\u4e0b\u3055\u3044): "+
JSON.stringify(a.mic_recorder_port),b;if(!SpeechRec._fn.is_number(a.mic_recorder_port)||0>a.mic_recorder_port||65535<a.mic_recorder_port)throw b={name:"invalid_config_value"},b.message="\u8a2d\u5b9a\u306b\u5931\u6557\u3057\u307e\u3057\u305f (config.mic_recorder_port\u306b\u306f0\uff5e65535\u306e\u6574\u6570\u3092\u6307\u5b9a\u3057\u3066\u4e0b\u3055\u3044): "+JSON.stringify(a.mic_recorder_port),b;}if("buffer_size_as_seconds"in a){if(!SpeechRec._fn.is_number(a.buffer_size_as_seconds))throw b={name:"invalid_config_value"},
b.message="\u8a2d\u5b9a\u306b\u5931\u6557\u3057\u307e\u3057\u305f (config.buffer_size_as_seconds\u306b\u306f1\uff5e60\u306e\u6570\u5024\u3092\u6307\u5b9a\u3057\u3066\u4e0b\u3055\u3044): "+JSON.stringify(a.buffer_size_as_seconds),b;if(1>a.buffer_size_as_seconds)throw b={name:"invalid_config_value"},b.message="\u8a2d\u5b9a\u306b\u5931\u6557\u3057\u307e\u3057\u305f (config.buffer_size_as_seconds\u306b\u306f1\uff5e60\u306e\u6570\u5024\u3092\u6307\u5b9a\u3057\u3066\u4e0b\u3055\u3044): "+JSON.stringify(a.buffer_size_as_seconds),
b;if(60<a.buffer_size_as_seconds)throw b={name:"invalid_config_value"},b.message="\u8a2d\u5b9a\u306b\u5931\u6557\u3057\u307e\u3057\u305f (config.buffer_size_as_seconds\u306b\u306f1\uff5e60\u306e\u6570\u5024\u3092\u6307\u5b9a\u3057\u3066\u4e0b\u3055\u3044): "+JSON.stringify(a.buffer_size_as_seconds),b;}if("UserDefine"in a){if(!SpeechRec._fn.is_string(a.UserDefine))throw b={name:"invalid_config_value"},b.message="\u8a2d\u5b9a\u306b\u5931\u6557\u3057\u307e\u3057\u305f (config.UserDefine\u306b\u306f\u6587\u5b57\u5217\u3092\u6307\u5b9a\u3057\u3066\u4e0b\u3055\u3044(\u9577\u3055255\u307e\u3067)): "+
JSON.stringify(a.UserDefine),b;if(255<a.UserDefine.length)throw b={name:"invalid_config_value"},b.message="\u8a2d\u5b9a\u306b\u5931\u6557\u3057\u307e\u3057\u305f (config.UserDefine\u306b\u306f\u6587\u5b57\u5217\u3092\u6307\u5b9a\u3057\u3066\u4e0b\u3055\u3044(\u9577\u3055255\u307e\u3067)): "+JSON.stringify(a.UserDefine),b;}if("UserAgent"in a&&!SpeechRec._fn.is_string(a.UserAgent))throw b={name:"invalid_config_value"},b.message="\u8a2d\u5b9a\u306b\u5931\u6557\u3057\u307e\u3057\u305f (config.UserAgent\u306b\u306f\u6587\u5b57\u5217\u3092\u6307\u5b9a\u3057\u3066\u4e0b\u3055\u3044(\u9577\u3055255\u307e\u3067)): "+
JSON.stringify(a.UserAgent),b;if("ContinuousMode"in a&&!SpeechRec._fn.is_boolean(a.ContinuousMode))throw b={name:"invalid_config_value"},b.message="\u8a2d\u5b9a\u306b\u5931\u6557\u3057\u307e\u3057\u305f (config.ContinuousMode\u306b\u306f\u771f\u507d\u5024\u3046\u3043\u6307\u5b9a\u3057\u3066\u4e0b\u3055\u3044): "+JSON.stringify(a.ContinuousMode),b;if("OpusWorkerUrl"in a){if(!SpeechRec._fn.is_string(a.OpusWorkerUrl))throw b={name:"invalid_config_value"},b.message="\u8a2d\u5b9a\u306b\u5931\u6557\u3057\u307e\u3057\u305f (config.OpusWorkerUrl\u306b\u306f\u6587\u5b57\u5217\u3092\u6307\u5b9a\u3057\u3066\u4e0b\u3055\u3044(\u9577\u30551\u4ee5\u4e0a)): "+
JSON.stringify(a.OpusWorkerUrl),b;if(0>=a.OpusWorkerUrl.length)throw b={name:"invalid_config_value"},b.message="\u8a2d\u5b9a\u306b\u5931\u6557\u3057\u307e\u3057\u305f (config.OpusWorkerUrl\u306b\u306f\u6587\u5b57\u5217\u3092\u6307\u5b9a\u3057\u3066\u4e0b\u3055\u3044(\u9577\u30551\u4ee5\u4e0a)): "+JSON.stringify(a.OpusWorkerUrl),b;}};
SpeechRec.start=function(){try{if("DENY"===this._state)throw{name:"runtime_error",message:"\u30de\u30a4\u30af\u304b\u3089\u306e\u97f3\u58f0\u53d6\u5f97\u304c\u62d2\u5426\u3055\u308c\u3066\u3044\u307e\u3059"};if("STOP"!==this._state)console.warn("SpeechRec.start()\u304c\u5b9f\u884c\u3055\u308c\u307e\u3057\u305f\u304c\u3001\u505c\u6b62\u4e2d\u72b6\u614b\u3067\u7121\u3044\u305f\u3081\u7121\u8996\u3057\u307e\u3059");else{if(!0!==SpeechRec._is_configured){var a={},c;for(c in SpeechRec._config)a[c]=SpeechRec._config[c];
SpeechRec.config(a)}SpeechRec._set_state("ASKING");SpeechRec._cb.all("ask");SpeechRec.is_chrome()?SpeechRec._cwa.ask(function(){SpeechRec._cb.all("allow");SpeechRec._set_state("ALLOW");SpeechRec._set_state("(CHANGING)");SpeechRec._rex.open(function(){var a={ApiKey:SpeechRec._config.ApiKey,NrFlag:SpeechRec._config.NrFlag,SbmMode:SpeechRec._config.SbmMode,UserDefine:SpeechRec._config.UserDefine,Nbest:SpeechRec._config.Nbest,ContinuousMode:SpeechRec._config.ContinuousMode};""!==SpeechRec._config.UserAgent&&
(a.UserAgent=SpeechRec._config.UserAgent);SpeechRec._rex.configure(a,function(){SpeechRec._rex.recognizer_open(function(){SpeechRec._rex.recognition_start(function(){SpeechRec._rex.set_one_time_callback("voiceless",SpeechRec._on_voiceless,!0);SpeechRec._rex.set_one_time_callback("voice_begin",SpeechRec._on_voice_begin);SpeechRec._cwa.open(function(){SpeechRec._set_state("START");SpeechRec._cb.all("start")},SpeechRec._on_audio)})})})})},function(){SpeechRec._cb.all("deny");SpeechRec._set_state("DENY")}):
SpeechRec._mic.ask(function(){SpeechRec._cb.all("allow");SpeechRec._set_state("ALLOW");SpeechRec._set_state("(CHANGING)");SpeechRec._mic.open(function(){SpeechRec._mic.configure({buffer_size_as_seconds:SpeechRec._config.buffer_size_as_seconds},function(){SpeechRec._mic.recording_start(function(){SpeechRec._rex.open(function(){var a={ApiKey:SpeechRec._config.ApiKey,NrFlag:SpeechRec._config.NrFlag,SbmMode:SpeechRec._config.SbmMode,UserDefine:SpeechRec._config.UserDefine,Nbest:SpeechRec._config.Nbest,
ContinuousMode:SpeechRec._config.ContinuousMode};""!==SpeechRec._config.UserAgent&&(a.UserAgent=SpeechRec._config.UserAgent);SpeechRec._rex.configure(a,function(){SpeechRec._rex.recognizer_open(function(){SpeechRec._rex.recognition_start(function(){SpeechRec._rex.set_one_time_callback("voiceless",SpeechRec._on_voiceless,!0);SpeechRec._rex.set_one_time_callback("voice_begin",SpeechRec._on_voice_begin);SpeechRec._mic.buffering_start(function(){SpeechRec._mic.transfer();SpeechRec._set_state("START");
SpeechRec._cb.all("start")})})})})})})})})},function(){SpeechRec._cb.all("deny");SpeechRec._set_state("DENY")})}}catch(b){SpeechRec._error_in_client(b)}};
...
a.NrFlag);"SbmMode"in a&&(SpeechRec._config.SbmMode=a.SbmMode);"Nbest"in a&&(SpeechRec._config.Nbest=a.Nbest);"ContinuousMode"in a&&(SpeechRec._config.ContinuousMode=a.ContinuousMode);"UserDefine"in a&&(SpeechRec._config.UserDefine=a.UserDefine);"UserAgent"in a&&(SpeechRec._config.UserAgent=a.UserAgent);"mic_recorder_port"in a&&(SpeechRec._config.mic_recorder_port=a.mic_recorder_port);SpeechRec._validate_config(SpeechRec._config,!0);SpeechRec._is_configured||(SpeechRec._rex.initialize({url:"wss://d02-h.speechrec.ntt-it.co.jp:59142/recognize",
on_error:SpeechRec._error_in_rex,callbacks:{}}),SpeechRec.is_chrome()?SpeechRec._cwa.initialize({on_pcm:SpeechRec._rex.on_pcm}):SpeechRec._mic.initialize({url:"wss://localhost:"+SpeechRec._config.mic_recorder_port+"/",on_error:SpeechRec._error_in_mic,callbacks:{audio_device_found:function(){SpeechRec._cb.all("mic_enabled")},audio_device_lost:function(){SpeechRec._cb.all("mic_disabled")},audio_pressure_level:function(a){SpeechRec._cb.all("audio_pressure_level",a)}}}));SpeechRec._is_configured=!0;a=
{};a=SpeechRec.is_chrome()?{OpusWorkerUrl:SpeechRec._config.OpusWorkerUrl,UserDefine:SpeechRec._config.UserDefine,UserAgent:SpeechRec._config.UserAgent,ContinuousMode:SpeechRec._config.ContinuousMode,NrFlag:SpeechRec._config.NrFlag,SbmMode:SpeechRec._config.SbmMode,Nbest:SpeechRec._config.Nbest}:{OpusWorkerUrl:SpeechRec._config.OpusWorkerUrl,UserDefine:SpeechRec._config.UserDefine,UserAgent:SpeechRec._config.UserAgent,ContinuousMode:SpeechRec._config.ContinuousMode,NrFlag:SpeechRec._config.NrFlag,
SbmMode:SpeechRec._config.SbmMode,Nbest:SpeechRec._config.Nbest,mic_recorder_port:SpeechRec._config.mic_recorder_port};SpeechRec._cb.all("config",a)}}catch(b){SpeechRec._error_in_client(b)}};SpeechRec._state="STOP";SpeechRec._config=SpeechRec.DEFAULT_CONFIG;SpeechRec._state_changed();SpeechRec.mute_on=function(){SpeechRec.is_mute=!0};SpeechRec.mute_off=function(){SpeechRec.is_mute=!1};
